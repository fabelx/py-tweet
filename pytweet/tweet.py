...
async def fetch_tweet(tweet_id) -> dict:
    ...
    This function sends an asynchronous GET request to the X API to fetch the tweet data
...
async def get_tweet(tweet_id: str, as_dict: bool = False) -> dict | Tweet | None:
